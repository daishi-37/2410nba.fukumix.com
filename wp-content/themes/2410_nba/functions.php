...
function theme_enqueue_styles() {
    ...
    */
    ...
    if(is_page(array('service01', 'service02','service03')) || is_front_page()) {
        wp_enqueue_style('slick'     , THEMELIB.'/slick/slick.css'    , ''             , '1.8.1' , 'all' );
        wp_enqueue_script('slick'    , THEMELIB.'/slick/slick.min.js' , array('jquery'), '1.8.1' , array('strategy' => 'defer', 'in_footer' => true));
        wp_enqueue_script('sc-slick' , THEMEJS.'/slick.js'            , array('script'), date('YmdHi', filemtime(THEMEDIRJS.'/slick.js'))           , array('strategy' => 'defer', 'in_footer' => true));
    }
    wp_enqueue_style('endo'        , THEMECSS.'/endo.css'                            , '', date('YmdHi', filemtime(THEMEDIRCSS.'/endo.css')) , 'all' );
...
require_once(THEMEDIR.'inc/cpt/voices.php');
require_once(THEMEDIR.'inc/cpt/staffs.php');